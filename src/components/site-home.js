...
class SiteHome extends PageViewElement {
  _render(props) {
    return html`
      ${SharedStyles}
      <style>
      ...
      <figure class="hero">
        <img
        src="http://www.chanel.com/i18n/en_WW/slides/1600_COCO_CRUSH_25042018.jpg"
        alt="A woman driving a car wearing lots of bling">	
      ...
      <site-aside items="${props.data.aside}"></site-aside>
...
window.customElements.define('site-home', SiteHome);
